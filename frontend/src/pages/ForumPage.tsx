        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          {pages.length === 0 ? (
            <div className="text-center py-12">
              ...
              <h2 className="text-2xl font-bold mb-2">No Forum Topics Available</h2>
              <p className="text-gray-600">Check back soon for forum discussions.</p>
            </div>
          ) : (
                ...
                >
                  ...
                  >
                    <div className="flex items-start justify-between">
                      ...
                      <ChevronRight className="h-6 w-6 text-gray-400 group-hover:text-green-600 transition-colors ml-4 flex-shrink-0" />
                    </div>
                  </Link>
                </motion.div>
              ))}
